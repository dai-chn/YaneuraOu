// HalfKA 512x2-16-32 (report/43 第II期: 入力近代化 = 玉を特徴に含める)
// bullet 側 ShogiHalfKA (81 バケット x 1710 = 138,510 次元) と対。レイヤ構成は HalfKP 版と同一。
// NNUE評価関数で用いる入力特徴量とネットワーク構造の定義
#ifndef CLASSIC_NNUE_HALFKA_512X2_16_32_H_INCLUDED
#define CLASSIC_NNUE_HALFKA_512X2_16_32_H_INCLUDED
