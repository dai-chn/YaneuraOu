// HalfKP 512x2-16-32 + SCReLU FT activation (exp013 arm1 の 512 移植, report/43 A1)
// FT 直後の活性化を clamp(acc,0,127)^2 >> 7 に差し替える。レイヤ構成は無印と同一。
// NNUE評価関数で用いる入力特徴量とネットワーク構造の定義
#ifndef CLASSIC_NNUE_HALFKP_512X2_16_32_SCRELU_H_INCLUDED
#define CLASSIC_NNUE_HALFKP_512X2_16_32_SCRELU_H_INCLUDED
