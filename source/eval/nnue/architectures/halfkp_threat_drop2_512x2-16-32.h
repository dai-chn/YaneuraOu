...
// halfkp_512x2-16-32 に ThreatDrop2 (攻撃駒種も落とした利き粒度 2,916 次元) を連結した型 (task#73)
#ifndef CLASSIC_NNUE_HALFKP_THREAT_DROP2_512X2_16_32_H_INCLUDED
#define CLASSIC_NNUE_HALFKP_THREAT_DROP2_512X2_16_32_H_INCLUDED

#include "../features/feature_set.h"
#include "../features/half_kp.h"
#include "../features/threat_drop2.h"
...
//   bullet 側は KP が 0..125388、ThreatDrop2 が 125388.. なので、
//   FeatureSet<ThreatDrop2, HalfKP> と書くことで KP=Tail (オフセット 0)、
//   ThreatDrop2=Head (+125,388) になり bullet と一致する (総次元 128,304)。
using RawFeatures = Features::FeatureSet<
    Features::ThreatDrop2,
...
#endif // CLASSIC_NNUE_HALFKP_THREAT_DROP2_512X2_16_32_H_INCLUDED
